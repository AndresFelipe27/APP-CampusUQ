/**
 * Este paquete contiene la parte logica de la actividad SugerenciasActivity para la seccion de sugerencias
 */
 ...
 * Actividad (parte logica) para la creacion de la vista sugerencias que se mostrara al usuario
 */
public class SugerenciasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Metodo de inflado explicito para construir el layout activity_sugerencias.xml
